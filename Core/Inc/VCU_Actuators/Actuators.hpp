...
namespace VCU{
	...
	public:
    	...
    	DigitalOutput led_sleep, led_flash, led_fault, led_operational, led_can;
    	Actuators(Data<VEHICLE>& data) : brakes(data),
    			vehicle_leds(Pinout::LEDR, Pinout::LEDG, Pinout::LEDB),
    			led_sleep(Pinout::SLEEP_LED), led_flash(Pinout::FLASH_LED), led_fault(Pinout::FAULT_LED), led_operational(Pinout::OPERATIONAL_LED), led_can(Pinout::CAN_LED) {}
	};
}
